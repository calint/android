...
public abstract class itm extends a implements $.labeled{
	...
	final public void to(final xwriter x)throws Throwable{
		...
		for(final Field f:getClass().getFields())//? fieldorderissue
			flds.addFirst(f);
		x.nl().style();
		x.nl().css("table.fm","background:#fff;margin:1.5em 0 1em 6em");
		x.nl().css("table.fm","box-shadow:0 0 .5em rgba(0,0,0,1);border-radius:0px");
		x.nl().css("table.fm tr td","vertical-align:middle;padding:.5em 2em .5em 1em");
		x.nl().css("table.fm tr td.lbl","vertical-align:baseline;text-align:right;padding:1.5em 0 1em 5em;font-weight:bold");
//		x.nl().css("table.fm tr:last-child","border-top:1px dotted green");
		x.nl().css("input,select,textarea","padding:.5em;background:#fff;box-shadow:0 0 .5em rgba(0,0,0,.5)");
		x.nl().css("input.ln","width:100%");
		x.nl().css("input.nm","width:100%");
		x.nl().css("textarea.ls","width:100%;height:100px");
		x.nl().css("textarea.ed","width:64em;height:400px");
		x.nl().css("input.nbr","text-align:right;width:5em");
		x.nl().styleEnd();
		x.nl().table("fm");
		for(final Field f:flds){
			...
			if(t==4)
				...
				x.td("lbl").tago("label").attr("for",e.id()).tagoe().p(f.getName()).tagEnd("label").td();
